...
ActiveRecord::Schema.define(version: 2020_11_10_005433) do

  create_table "board_tag_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
